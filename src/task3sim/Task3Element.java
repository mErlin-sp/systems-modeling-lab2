...
public class Task3Element {
    ...
    private int state;
    private Task3Element nextElement;
    ...
    public Task3Element(double delay) {
        name = "anonymus";
        tnext = 0.0;
        delayMean = delay;
        distribution = "";
    ...
    public Task3Element(String nameOfElement, double delay) {
        name = nameOfElement;
        tnext = 0.0;
        delayMean = delay;
        distribution = "exp";
    ...
    public Task3Element getNextElement() {
        return nextElement;
    }

    public void setNextElement(Task3Element nextElement) {
