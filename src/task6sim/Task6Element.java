...
public class Task6Element {
    ...
    private int state;
    private List<Task6Element> nextElements;
    ...
    public Task6Element(double delay) {
        name = "anonymus";
        tnext = 0.0;
        delayMean = delay;
        distribution = "";
    ...
    public Task6Element(String nameOfElement, double delay) {
        name = nameOfElement;
        tnext = 0.0;
        delayMean = delay;
        distribution = "exp";
    ...
    public List<Task6Element> getNextElements() {
        return nextElements;
    }

    public void addNextElement(Task6Element nextElement) {
