...
public class Task5Element {
    ...
    private int state;
    private Task5Element nextElement;
    ...
    public Task5Element(double delay) {
        name = "anonymus";
        tnext = 0.0;
        delayMean = delay;
        distribution = "";
    ...
    public Task5Element(String nameOfElement, double delay) {
        name = nameOfElement;
        tnext = 0.0;
        delayMean = delay;
        distribution = "exp";
    ...
    public Task5Element getNextElement() {
        return nextElement;
    }

    public void setNextElement(Task5Element nextElement) {
